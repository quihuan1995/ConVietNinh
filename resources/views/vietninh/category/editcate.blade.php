...
<div id="AddCatemanagement"class="tabContent" style="padding: 0;border: none;">
    <div class="head-category" >
        <div id="category-span" >
            <span >Sửa danh mục : {{ $cate->categories }}</span>
        </div>
    </div>
        @if (session('thongbao'))
        ...
        <form method="post" enctype="multipart/form-data" action="">
            ...
            <div class="info-mobilecate">
                ...
                <div class="form-group" style="display: grid">
                    ...
                    <img id="img_cate" class="thumbnail"src="./image/category/{{ $cate->images_categories }}" style="width:30%;position:inherit;cursor: pointer;">
                </div>
                <div class="form-group">
                    <label for="">Tên danh mục</label>
                    <input type="text" id="name-category" name="categories" class="filter-input" value="{{ $cate->categories }}">
