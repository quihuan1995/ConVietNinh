...
<div id="detailOrder"class="tabContent" style="padding: 0;border: none;">
        <div class="head-order" >
            ...
            <div id="add-order" >
                <button class="btn btn-warning"  role="button" style="color: black" ><b>Đang thi công</b></button>
        ...
        <div id="main-order-work">
            ...
            <div class="table-product" >
                ...
                <div id="btn-success-order">
                <a  class="btn btn-success" href="/home/order/active/{{ $customer->id }}" role="button"  ><b>Hoàn Thành Đơn Hàng</b></a>
                </div>
            </div>


    <div class="admin-c" style="position: absolute;top: 50%;">
        @foreach($customer->order as $row)
