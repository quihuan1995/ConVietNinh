...
<div id="AddUsermanagement"class="tabContent" style="padding: 60px;border: none;">
    <div class="head-addaccount">
        ...
        <div id="main-addaccount">
            <form method="POST" enctype="multipart/form-data" action="/home/user/add-c">
                @csrf
            ...
            <div id="choose-account">
                ...
                <p>thuộc sự quản lý B:</p>
                    <select id="select-user" name="user_id_b" class="filter-input">
                        <option value="1">Quản lý B</option>
                        {{ GetUserB($userb,"") }}
                    </select>
            </div>
            <div class="account-pass" style="top:140px;">
                ...
                <div class="form-group" style="display: contents">
                    ...
                    <input id="user_id" type="text" name="user_id_c" class="filter-input" placeholder="Nhập mã "  >
