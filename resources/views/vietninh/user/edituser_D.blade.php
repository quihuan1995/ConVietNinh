...
<div class="head-addaccount" style="margin:5%">
    <h2>Sua tài khoản: <b>{{ $userd->name }}</b></h2>
</div>
<div id="main-addaccount">
    ...
    <div class="filter-form mb-2" id="creat-edit-user">
        <nav class="navbar navbar-expand">
            ...
            <img id="img_prd" class="thumbnail"src="./image/user/{{ $userd->avatar }}" style="width:30%;position:inherit;cursor: pointer;">
            </li>
                <li class="nav-item filter-li" id="customer-name" style="margin:5%;" >
                    <p class="filter-title"> <img src="./image/Icon feather-user.svg">Họ và Tên</p>
                    <input type="text" name="name" class="filter-input" value="{{ $userd->name }}" style="border-radius: 5px;opacity: 1;background-color:#F0F0F0;width:80%;">
                ...
                <li class="nav-item filter-li" id="number" style="margin:5%;" >
                    ...
                    <input type="text" name="phone" class="filter-input" value="{{ $userd->phone }}" style="border-radius: 5px;opacity: 1;background-color:#F0F0F0;width:80%;">
                      {{showErrors($errors,'phone')}}
                </li>
                <li class="nav-item filter-li" id="address" style="margin:5%;" >
                    <p class="filter-title"><img src="./image/icon-time.svg" >địa chỉ</p>
                    <textarea name="address" class="filter-input"  style="color: black;background-color:#F0F0F0;margin-right: 5%;width:80%;">{{ $userd->address }}</textarea>
    ...
    <div id="choose-account-edit">
        ...
        <select id="select-user" name="user_id_c" class="filter-input">
            {{ GetUserC($userc,$userd->user_id_c) }}
        </select>
    </div>
    <div class="account-pass"style="top:165px">
        ...
        <div class="form-group">
            ...
            <input name="password" id="password" type="password" value="{{ bcrypt($userd->password) }}" />
    ...
    <div class="form-group">
        ...
        <div class="form-group" style="display: contents">
            ...
            <input id="user_id" type="text" name="user_id_d" class="filter-input" value="{{ $userd->user_id_d }}" >
                    ...
                    <nav class="navbar navbar-expand">
                        ...
                        <ul class="navbar-nav row filter-ul">
                            <li class="nav-item filter-li"   style="margin-left:6px;margin-top: 10px;">
                                ...
                                <input id="date" type="date" name="date_in" class="filter-input" value="{{ $userd->date_in }}" >
                            </li>
                            <li class="nav-item filter-li"  style="margin-top: 10px;">
                                <p class="filter-title">Ngày Nghỉ</p>
                                <input id="date" type="date" name="date_out" class="filter-input" value="{{ $userd->date_out }}"  >
                            </li>
                            <li class="nav-item filter-li" id="customer-name" style="margin-left: 10%;margin-top: -19%;">
                                ...
                                <select name="state" class="filter-input" style="width: 135px">
                                    ...
                                    <option @if($userd->state==1) selected @endif value="1">Vẫn làm</option>
                                    <option @if($userd->state==2) selected @endif value="2">Đã Nghỉ</option>
                                </select>
                            </li>
                        </ul>
                    </nav>
